...
<Info>Previous version [is available here](/legal/archives/service-level-agreement-2022-02-22). Please read [Update Notices](/legal/archives/terms-update-notices), which explains the changes.</Info>
...
- Any disruptions, degradation or failures of service resulting from changes, updates or modifications made to third-party services.
